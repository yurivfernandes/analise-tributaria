        ...
        try {
          ...
          const { error: insertError } = await supabase
            ...
            .upsert({
              ...
              company_name: form.registrationType === 'company' ? form.companyName : null,
              phone: form.phone,
              email: form.email,
              ...
              inss_autonomo: form.inssAutonomo,
              ir_to_pay: form.irToPay,
              ir_to_refund: form.irToRefund,
              ir_carne_leao: form.irCarneLeao,
              monthly_salary: form.monthlySalary,
              dependents_livro_caixa: form.dependentsLivroCaixa,
              issqn: form.issqn,
              status: form.status,
              cnae_code: form.cnaeCode,
